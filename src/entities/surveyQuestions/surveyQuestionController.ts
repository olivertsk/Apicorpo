...
import { ISurveyQuestionAttributes, ISurveyQuestionCreationAttributes, IResponseAllSurveyQuestion, ISurveyQuestionFilter, ISurveyQuestionUpdateAttributes } from '@entities/surveyQuestions/surveyQuestionModel';
