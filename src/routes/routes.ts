...
const models: TsoaRoute.Models = {
  'FileType': {
    ...
    type: {
      dataType: 'union',
      subSchemas: [
        { dataType: 'enum', enums: ['products'] },
        { dataType: 'enum', enums: ['departments'] },
        { dataType: 'enum', enums: ['categories'] },
        { dataType: 'enum', enums: ['banners'] },
        { dataType: 'enum', enums: ['maps'] },
  ...
  'IResponseAllView': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IViewAttributes' },
        required: true,
      },
  ...
  'IViewCreationAttributes': {
    ...
    type: {
      ...
      subSchemas: [
        { ref: 'Pick_IViewAttributes.id-or-route-or-url_' },
        { ref: 'Partial_Pick_IViewAttributes.name__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            icon: {
  ...
  'IResponseAllUser': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IUserAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'IUserCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IUserAttributes.id-or-email-or-password_' },
        { ref: 'Partial_Pick_IUserAttributes.name__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            receiveNotification: { dataType: 'boolean' },
  ...
  'Pick_IUserAttributes.id-or-rolId_': {
    ...
    type: {
      ...
      nestedProperties: {
        id: { dataType: 'string' },
        rolId: { dataType: 'string', required: true },
      },
      validators: {},
    },
  },
  ...
  'Pick_IUserAttributes.Exclude_keyofIUserAttributes.password__': {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        dni: { dataType: 'union', subSchemas: [{ dataType: 'string' }, { dataType: 'double' }] },
        dniType: { dataType: 'string' },
  ...
  'IUserUpdatenAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IUserAttributes.id-or-rolId_' },
        { ref: 'Omit_IUserAttributes.password_' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            dob: {
  ...
  'IResponseAllRol': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IRolAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'ISurveyAttributes': {
    ...
    properties: {
      ...
      type: {
        dataType: 'union',
        subSchemas: [{ ref: 'ESurveyType' }, { dataType: 'enum', enums: [null] }],
      },
      createdAt: { dataType: 'datetime' },
      updatedAt: { dataType: 'datetime' },
      deletedAt: {
  ...
  'IResponseAllSurvey': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ISurveyAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'ISurveyCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_ISurveyAttributes.title-or-description_' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            deletedAt: {
  ...
  'IResponseAllSurveyUser': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ISurveyUserAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'ISurveyResponseCreationAttributes': {
    ...
    type: {
      ...
      nestedProperties: {
        responses: {
          dataType: 'array',
          array: { dataType: 'refObject', ref: 'ISurveyResponseAttributes' },
          required: true,
        },
        surveyUserId: {
          dataType: 'union',
  ...
  'ISurveyQuestionAttributes': {
    ...
    properties: {
      ...
      order: {
        dataType: 'union',
        subSchemas: [{ dataType: 'double' }, { dataType: 'enum', enums: [0] }],
      },
      surveyId: { dataType: 'string' },
      createdAt: { dataType: 'datetime' },
      updatedAt: { dataType: 'datetime' },
  ...
  'IResponseAllSurveyQuestion': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ISurveyQuestionAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'Pick_ISurveyQuestionAttributes.text_': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { text: { dataType: 'string' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  'ISurveyQuestionCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_ISurveyQuestionAttributes.text_' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            deletedAt: {
  ...
  'ISurveyAnswerOptionAttributes': {
    ...
    properties: {
      ...
      type: {
        dataType: 'union',
        subSchemas: [{ ref: 'ESurveyAnswerOptionType' }, { dataType: 'enum', enums: [null] }],
      },
      createdAt: { dataType: 'datetime' },
      updatedAt: { dataType: 'datetime' },
      deletedAt: {
  ...
  'IResponseAllSurveyAnswerOption': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ISurveyAnswerOptionAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'Pick_ISurveyAnswerOptionAttributes.text-or-questionId_': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { text: { dataType: 'string' }, questionId: { dataType: 'string' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  'ISurveyAnswerOptionCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_ISurveyAnswerOptionAttributes.text-or-questionId_' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            deletedAt: {
  ...
  'IResponseAllProduct': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IProductAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'IProductFilter': {
    ...
    properties: {
      ...
      order: {
        dataType: 'union',
        subSchemas: [
          { dataType: 'enum', enums: ['maxPrice'] },
          { dataType: 'enum', enums: ['minPrice'] },
        ],
      },
      typeSearch: {
        dataType: 'union',
  ...
  'Pick_IProductImageAttributes.id-or-isVideo_': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { id: { dataType: 'string' }, isVideo: { dataType: 'boolean' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  'Partial_Pick_IProductImageAttributes.file-or-productId__': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { file: { dataType: 'string' }, productId: { dataType: 'string' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  'IProductImageCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IProductImageAttributes.id-or-isVideo_' },
        { ref: 'Partial_Pick_IProductImageAttributes.file-or-productId__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            alt: {
  ...
  'IProductCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IProductAttributes.id-or-departmentId-or-categoryId-or-description_' },
        { ref: 'Partial_Pick_IProductAttributes.name-or-code-or-price-or-priceWithTax__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            images: {
              dataType: 'array',
              array: { dataType: 'refAlias', ref: 'IProductImageCreationAttributes' },
            },
            coverImage: {
              dataType: 'union',
              subSchemas: [{ dataType: 'string' }, { dataType: 'enum', enums: [null] }],
            ...
            status: {
              dataType: 'union',
              subSchemas: [{ dataType: 'boolean' }, { dataType: 'enum', enums: [true] }],
            },
          },
        },
      ],
  ...
  'IResponseAllFavoriteProduct': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IFavoriteProductAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'Pick_IFavoriteProductAttributes.productId_': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { productId: { dataType: 'string', required: true } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  'Partial_Pick_IFavoriteProductAttributes.id-or-userId__': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { id: { dataType: 'string' }, userId: { dataType: 'string' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  'IFavoriteProductCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IFavoriteProductAttributes.productId_' },
        { ref: 'Partial_Pick_IFavoriteProductAttributes.id-or-userId__' },
      ],
      validators: {},
    },
  },
  ...
  'ETypePaymentMethods': {
    dataType: 'refEnum',
    enums: ['cash', 'bank', 'zelle', 'pago movil'],
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  'IResponseAllPaymentMethod': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IPaymentMethodAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'Pick_IPaymentMethodAttributes.id_': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { id: { dataType: 'string' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  'IPaymentMethodCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IPaymentMethodAttributes.id_' },
        { ref: 'Partial_Pick_IPaymentMethodAttributes.name__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            phoneNumber: {
            ...
            type: {
              dataType: 'union',
              subSchemas: [{ ref: 'ETypePaymentMethods' }, { ref: 'ETypePaymentMethods.Cash' }],
              required: true,
            },
            status: {
              dataType: 'union',
  ...
  'IOrderAttributes': {
    ...
    properties: {
      ...
      status: {
        dataType: 'union',
        subSchemas: [{ ref: 'EStatusOrder' }, { dataType: 'enum', enums: [null] }],
      },
      adminId: {
        dataType: 'union',
        subSchemas: [{ dataType: 'string' }, { dataType: 'enum', enums: [null] }],
      ...
      typePayment: {
        dataType: 'union',
        subSchemas: [{ ref: 'ETypePaymentMethods' }, { dataType: 'enum', enums: [null] }],
      },
      paymentMethodId: {
        dataType: 'union',
        subSchemas: [{ dataType: 'string' }, { dataType: 'enum', enums: [null] }],
  ...
  'IResponseAllOrder': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IOrderAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
      status: {
  ...
  'Partial_Pick_IOrderAttributes.userId-or-dniType-or-dni-or-date-or-amount-or-amountWithoutTax-or-valueTax-or-location-or-nameClient-or-phoneNumber__':
    {
      ...
      type: {
        ...
        nestedProperties: {
          ...
          amountWithoutTax: { dataType: 'double' },
          valueTax: { dataType: 'double' },
          nameClient: { dataType: 'string' },
        },
        validators: {},
      },
    },
  ...
  'Partial_Pick_IOrderProductAttributes.productId-or-orderId-or-code-or-salePrice-or-valueTax-or-quantity-or-subtotalTax-or-subtotal__':
    {
      ...
      type: {
        ...
        nestedProperties: {
          ...
          salePrice: { dataType: 'double' },
          quantity: { dataType: 'double' },
          subtotalTax: { dataType: 'double' },
  ...
  'IOrderProductCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IOrderProductAttributes.id_' },
        {
          ref: 'Partial_Pick_IOrderProductAttributes.productId-or-orderId-or-code-or-salePrice-or-valueTax-or-quantity-or-subtotalTax-or-subtotal__',
        },
      ],
      validators: {},
    },
  ...
  'IOrderCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IOrderAttributes.id_' },
        {
          ref: 'Partial_Pick_IOrderAttributes.userId-or-dniType-or-dni-or-date-or-amount-or-amountWithoutTax-or-valueTax-or-location-or-nameClient-or-phoneNumber__',
        },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            ...
            products: {
              dataType: 'array',
              array: { dataType: 'refAlias', ref: 'IOrderProductCreationAttributes' },
            },
          },
        },
      ],
  ...
  'IResponseAllNotification': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'INotificationAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'IResponseAllMap': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IMapAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'IMapCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IMapAttributes.id_' },
        { ref: 'Partial_Pick_IMapAttributes.name-or-image-or-map__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            deletedAt: { dataType: 'enum', enums: [null] },
            order: {
              dataType: 'union',
              subSchemas: [{ dataType: 'double' }, { dataType: 'enum', enums: [0] }],
            },
  ...
  'IUploadZipReponse': {
    ...
    properties: {
      result: {
        ...
        nestedProperties: {
          msg: { dataType: 'string', required: true },
          file: { dataType: 'double', required: true },
          status: { dataType: 'boolean', required: true },
        },
        required: true,
      },
      errors: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IUploadZipReponseError' },
        required: true,
      },
    },
    additionalProperties: false,
  ...
  'IResponseAllDepartment': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IDepartmentAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'Pick_IDepartmentAttributes.id-or-description_': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { id: { dataType: 'string' }, description: { dataType: 'string' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  'IDepartmentCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IDepartmentAttributes.id-or-description_' },
        { ref: 'Partial_Pick_IDepartmentAttributes.name__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            icon: {
            ...
            isSalient: {
              dataType: 'union',
              subSchemas: [{ dataType: 'boolean' }, { dataType: 'enum', enums: [false] }],
              required: true,
            },
            status: {
              dataType: 'union',
  ...
  'IResponseAllCategory': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'ICategoryAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'ICategoryCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_ICategoryAttributes.id-or-description-or-icon_' },
        { ref: 'Partial_Pick_ICategoryAttributes.name__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            isSalient: {
  ...
  'IResponseAllBanner': {
    ...
    properties: {
      ...
      data: {
        dataType: 'array',
        array: { dataType: 'refObject', ref: 'IBannerAttributes' },
        required: true,
      },
      actualPage: { dataType: 'double' },
    },
  ...
  'Partial_Pick_IBannerAttributes.name-or-images__': {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: { name: { dataType: 'string' }, images: { dataType: 'string' } },
      validators: {},
    },
  },
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  ...
  'IBannerCreationAttributes': {
    ...
    type: {
      dataType: 'intersection',
      subSchemas: [
        { ref: 'Pick_IBannerAttributes.id_' },
        { ref: 'Partial_Pick_IBannerAttributes.name-or-images__' },
        {
          dataType: 'nestedObjectLiteral',
          nestedProperties: {
            mobileImage: {
            ...
            position: {
              dataType: 'union',
              subSchemas: [{ ref: 'EPositionBanner' }, { ref: 'EPositionBanner.HomePrincipal' }],
            },
            alt: {
              dataType: 'union',
              subSchemas: [{ dataType: 'string' }, { dataType: 'enum', enums: [null] }],
...
export function RegisterRoutes(app: Router, opts?: { multer?: ReturnType<typeof multer> }) {
  ...
  const argsFileController_delete: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      nestedProperties: {
        type: {
          dataType: 'union',
          subSchemas: [{ ref: 'FileType' }, { dataType: 'enum', enums: [null] }],
        },
  ...
  app.delete(
    ...
    async function FileController_delete(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsFileController_delete,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function ViewsController_create(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsViewsController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function ViewsController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsViewsController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function ViewsController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsViewsController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function UsersController_create(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUsersController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function UsersController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUsersController_update,
          request,
          response,
        })
  ...
  const argsUsersController_updateTokenPush: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    requestBody: {
      ...
      required: true,
      dataType: 'nestedObjectLiteral',
      nestedProperties: { tokenPush: { dataType: 'string', required: true } },
    },
  }
  app.put(
    '/users/updateTokenPush',
    authenticateMiddleware([{ bearerAuth: ['optional'] }]),
    ...fetchMiddlewares<RequestHandler>(UsersController),
    ...fetchMiddlewares<RequestHandler>(UsersController.prototype.updateTokenPush),

    async function UsersController_updateTokenPush(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUsersController_updateTokenPush,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function UsersController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUsersController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function RolsController_create(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRolsController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function RolsController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRolsController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function RolsController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsRolsController_softDeleteRecord,
          request,
          response,
        })
  ...
  const argsAuthController_passwordUpdate: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    pRequestBody: {
      ...
      dataType: 'nestedObjectLiteral',
      nestedProperties: {
        oldPasword: { dataType: 'string', required: true },
        password: { dataType: 'string', required: true },
  ...
  app.patch(
    ...
    async function AuthController_passwordUpdate(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_passwordUpdate,
          request,
          response,
        })
  ...
  const argsAuthController_update: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'IAuthUserUpdatenAttributes',
    },
  }
  app.put(
    '/auth/update/:userId',
    ...
    async function AuthController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_update,
          request,
          response,
        })
  ...
  app.patch(
    ...
    async function AuthController_updateTokenPush(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_updateTokenPush,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function AuthController_passwordReset(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_passwordReset,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function AuthController_passwordRecovery(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_passwordRecovery,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function AuthController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsAuthController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function SurveysController_get(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveysController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function SurveysController_all(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveysController_all,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function SurveysController_leftSurvey(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveysController_leftSurvey,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function SurveysController_create(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveysController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function SurveysController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveysController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function SurveysController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveysController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    '/surveyResponses/show/:surveyResponseId',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...
    async function SurveyResponsesController_get(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyResponsesController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function SurveyResponsesController_allUser(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyResponsesController_allUser,
          request,
          response,
        })
  ...
  const argsSurveyResponsesController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'ISurveyResponseCreationAttributes',
    },
    request: { in: 'request', name: 'request', required: true, dataType: 'object' },
  }
  app.post(
    ...
    async function SurveyResponsesController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyResponsesController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function SurveyResponsesController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyResponsesController_update,
          request,
          response,
        })
  ...
  const argsSurveyResponsesController_updateUser: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'ISurveyUserUpdateAttributes',
    },
  }
  app.put(
    '/surveyResponses/updateUser/:surveyUserId',
    ...fetchMiddlewares<RequestHandler>(SurveyResponsesController),
    ...fetchMiddlewares<RequestHandler>(SurveyResponsesController.prototype.updateUser),

    async function SurveyResponsesController_updateUser(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyResponsesController_updateUser,
          request,
          response,
        })
  ...
  app.delete(
    '/surveyResponses/deleted/:key',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(SurveyResponsesController),
    ...fetchMiddlewares<RequestHandler>(SurveyResponsesController.prototype.softDeleteRecord),

    async function SurveyResponsesController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyResponsesController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    '/surveyQuestions/show/:surveyQuestionId',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...
    async function SurveyQuestionsController_get(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyQuestionsController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function SurveyQuestionsController_all(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyQuestionsController_all,
          request,
          response,
        })
  ...
  const argsSurveyQuestionsController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'ISurveyQuestionCreationAttributes',
    },
  }
  app.post(
    ...
    async function SurveyQuestionsController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyQuestionsController_create,
          request,
          response,
        })
  ...
  const argsSurveyQuestionsController_update: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'ISurveyQuestionUpdateAttributes',
    },
  }
  app.put(
    '/surveyQuestions/update/:surveyQuestionId',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(SurveyQuestionsController),
    ...fetchMiddlewares<RequestHandler>(SurveyQuestionsController.prototype.update),

    async function SurveyQuestionsController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyQuestionsController_update,
          request,
          response,
        })
  ...
  app.delete(
    '/surveyQuestions/deleted/:key',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(SurveyQuestionsController),
    ...fetchMiddlewares<RequestHandler>(SurveyQuestionsController.prototype.softDeleteRecord),

    async function SurveyQuestionsController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyQuestionsController_softDeleteRecord,
          request,
          response,
        })
  ...
  const argsSurveyAnswerOptionsController_get: Record<string, TsoaRoute.ParameterSchema> = {
    surveyAnswerOptionId: {
      in: 'path',
      name: 'surveyAnswerOptionId',
      required: true,
      dataType: 'string',
    },
  }
  app.get(
    '/surveyAnswerOptions/show/:surveyAnswerOptionId',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...
    async function SurveyAnswerOptionsController_get(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyAnswerOptionsController_get,
          request,
          response,
        })
  ...
  const argsSurveyAnswerOptionsController_all: Record<string, TsoaRoute.ParameterSchema> = {
    pQueryParams: {
      ...
      name: 'pQueryParams',
      required: true,
      ref: 'ISurveyAnswerOptionFilter',
    },
  }
  app.get(
    '/surveyAnswerOptions/all',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController.prototype.all),

    async function SurveyAnswerOptionsController_all(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyAnswerOptionsController_all,
          request,
          response,
        })
  ...
  const argsSurveyAnswerOptionsController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'ISurveyAnswerOptionCreationAttributes',
    },
  }
  app.post(
    '/surveyAnswerOptions/create',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController.prototype.create),

    async function SurveyAnswerOptionsController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyAnswerOptionsController_create,
          request,
          response,
        })
  ...
  const argsSurveyAnswerOptionsController_update: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'ISurveyAnswerOptionAttributes',
    },
  }
  app.put(
    '/surveyAnswerOptions/update/:surveyAnswerOptionId',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController.prototype.update),

    async function SurveyAnswerOptionsController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyAnswerOptionsController_update,
          request,
          response,
        })
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsSurveyAnswerOptionsController_softDeleteRecord: Record<
    string,
  ...
  app.delete(
    '/surveyAnswerOptions/deleted/:key',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController),
    ...fetchMiddlewares<RequestHandler>(SurveyAnswerOptionsController.prototype.softDeleteRecord),

    async function SurveyAnswerOptionsController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsSurveyAnswerOptionsController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ProductsController_get(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ProductsController_all(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_all,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function ProductsController_search(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_search,
          request,
          response,
        })
  ...
  const argsProductsController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'IProductCreationAttributes',
    },
  }
  app.post(
    '/products/create',
    ...
    async function ProductsController_create(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function ProductsController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function ProductsController_softDeleteRecord(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function ProductsController_imagesDelete(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsProductsController_imagesDelete,
          request,
          response,
        })
  ...
  app.get(
    '/favoriteProducts/show/:favoriteProductId',
    authenticateMiddleware([{ bearerAuth: ['optional'] }]),
    ...
    async function FavoriteProductsController_get(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsFavoriteProductsController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function FavoriteProductsController_all(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsFavoriteProductsController_all,
          request,
          response,
        })
  ...
  const argsFavoriteProductsController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'IFavoriteProductCreationAttributes',
    },
    req: { in: 'request', name: 'req', required: true, dataType: 'object' },
  }
  app.post(
    ...
    async function FavoriteProductsController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsFavoriteProductsController_create,
          request,
          response,
        })
  ...
  app.put(
    '/favoriteProducts/update/:favoriteProductId',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(FavoriteProductsController),
    ...fetchMiddlewares<RequestHandler>(FavoriteProductsController.prototype.update),

    async function FavoriteProductsController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsFavoriteProductsController_update,
          request,
          response,
        })
  ...
  app.delete(
    '/favoriteProducts/deleted/:key',
    authenticateMiddleware([{ bearerAuth: ['admin'] }]),
    ...fetchMiddlewares<RequestHandler>(FavoriteProductsController),
    ...fetchMiddlewares<RequestHandler>(FavoriteProductsController.prototype.softDeleteRecord),

    async function FavoriteProductsController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsFavoriteProductsController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    '/paymentMethods/show/:paymentMethodId',
    ...
    async function PaymentMethodsController_get(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPaymentMethodsController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function PaymentMethodsController_all(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPaymentMethodsController_all,
          request,
          response,
        })
  ...
  const argsPaymentMethodsController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'IPaymentMethodCreationAttributes',
    },
  }
  app.post(
    ...
    async function PaymentMethodsController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPaymentMethodsController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function PaymentMethodsController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPaymentMethodsController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function PaymentMethodsController_softDeleteRecord(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsPaymentMethodsController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function OrdersController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrdersController_update,
          request,
          response,
        })
  ...
  const argsOrdersController_updateStatus: Record<string, TsoaRoute.ParameterSchema> = {
    ...
    body: {
      ...
      nestedProperties: {
        ...
        status: { ref: 'EStatusOrder', required: true },
      },
    },
    request: { in: 'request', name: 'request', required: true, dataType: 'object' },
  }
  app.put(
    ...
    async function OrdersController_updateStatus(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrdersController_updateStatus,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function OrdersController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsOrdersController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function notificationController_test(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsnotificationController_test,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function notificationController_all(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsnotificationController_all,
          request,
          response,
        })
  ...
  app.patch(
    ...
    async function notificationController_isView(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsnotificationController_isView,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function MapsController_create(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsMapsController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function MapsController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsMapsController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function MapsController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsMapsController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function A2IntegrationController_downloadOrder(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsA2IntegrationController_downloadOrder,
          request,
          response,
        })
  ...
  // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
  const argsA2IntegrationController_downloadProductOrder: Record<
    string,
    TsoaRoute.ParameterSchema
  > = {
    requestBody: {
  ...
  app.get(
    ...
    async function A2IntegrationController_downloadProductOrder(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsA2IntegrationController_downloadProductOrder,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function A2IntegrationController_outputProduct(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsA2IntegrationController_outputProduct,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function A2IntegrationController_uploadZip(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsA2IntegrationController_uploadZip,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function DepartmentsController_get(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsDepartmentsController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function DepartmentsController_all(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsDepartmentsController_all,
          request,
          response,
        })
  ...
  const argsDepartmentsController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'IDepartmentCreationAttributes',
    },
  }
  app.post(
    '/departments/create',
    ...
    async function DepartmentsController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsDepartmentsController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function DepartmentsController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsDepartmentsController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function DepartmentsController_softDeleteRecord(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsDepartmentsController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function CategoriesController_get(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsCategoriesController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function CategoriesController_all(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsCategoriesController_all,
          request,
          response,
        })
  ...
  const argsCategoriesController_create: Record<string, TsoaRoute.ParameterSchema> = {
    requestBody: {
      ...
      name: 'requestBody',
      required: true,
      ref: 'ICategoryCreationAttributes',
    },
  }
  app.post(
    '/categories/create',
    ...
    async function CategoriesController_create(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsCategoriesController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function CategoriesController_update(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsCategoriesController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function CategoriesController_softDeleteRecord(
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsCategoriesController_softDeleteRecord,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function BannersController_get(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBannersController_get,
          request,
          response,
        })
  ...
  app.get(
    ...
    async function BannersController_all(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBannersController_all,
          request,
          response,
        })
  ...
  app.post(
    ...
    async function BannersController_create(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBannersController_create,
          request,
          response,
        })
  ...
  app.put(
    ...
    async function BannersController_update(request: ExRequest, response: ExResponse, next: any) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBannersController_update,
          request,
          response,
        })
  ...
  app.delete(
    ...
    async function BannersController_softDeleteRecord(
      request: ExRequest,
      response: ExResponse,
      next: any
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsBannersController_softDeleteRecord,
          request,
          response,
        })
